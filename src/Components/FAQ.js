        ...
        <div>
            ...
            <NavBar/>
                ...
                <div className="faq">
                    ...
                    <p>Kipu's Rescue is a nonprofit organization that finds homes for abandoned cats and dogs throughout 
                    the Tri-State area, and provides behavior intervention when needed to improve chances of adoption.  
                    Founded in 1967, we operate an animal shelter in Manhattan. We also provide programs 
                    ...
                    <p>When you see an animal on our website that you like, you should submit an inquiry to get the process started. 
                    You will then be connected with an adoptions counselor who can tell you more about the animal or schedule an appointment 
                    to come meet them! In general, you’ll fill out our adoption application after meeting with the animal at our facility. 
                    ...
                    For dog adopters, we ask for your building information to make sure you are allowed to have dogs in your apartment. 
                    This information can be in the form of a lease, phone number of a leasing office, landlord, super, or property website. 
                    If you currently have or previously had a pet, we ask for your vet’s information.
                    
                    <br/>
                    If you are looking to adopt a dog, we ask that all members of the household be present to meet the dog (or will be able to come down to meet the dog at some point). 
                    This includes other dogs in the household. We want the dogs’ first meeting to be in the safety of the shelter with our staff present.
                    
                    <br/>
                    Some cat adoptions can be processed same-day. Dogs may take a few days.

                    <br/>
                    Adopters must provide proof of vaccination or wear a mask while at our facility.
                    </p>

                    <h6>6) Are there fees to adopt?</h6>
                    <p>Yes. Adoption Fees are:
                        <ul>
                            <li>$175 per cat</li>
                            ...
                            <li>$450 per puppy 4 months and under (includes collar and leash)</li>
                        </ul>
                    </p>

                    <h6>7) How do I volunteer?</h6>
                    <p>Please visit the <a href="/volunteer"><strong><em> volunteer section</em></strong></a> of our website.</p>

                    <h6>8) Do you have a foster program?</h6>
                    <p>We do utilize fosters for some of our animals, including neonatal (bottle-baby) kittens. 
                    Our fosters are recruited from within our shelter volunteers. If you’re interested in fostering for Kipu's Rescue,
