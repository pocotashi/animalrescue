...
function Support() {
    return (
        <div>
            ...
            <div>
                <img className="firstImage" alt="adoptPage" src="https://usserviceanimals.org/blog/wp-content/uploads/2019/08/1530083188458-768x599.png"/>
            </div>
                    ...
                    <Row>
                        <Col xs={8}> */}
                            <div className="supportTitle">
                                ...
                                <h6>There are many ways you can make a difference for the dogs and cats at Kipu's Rescue!</h6>
                            </div>

                            <h3><strong>Donation</strong></h3>
                            <p>Your donation saves lives. With it, we can give animals the help they need. 
                            <a href="/donate"><em><strong> Donate Now</strong></em></a></p>
                            ...
                            <a href="/volunteer"><em><strong> Check out our volunteer page</strong></em></a></p>

                            <h3><strong>Shop Our Online Store</strong></h3>
                            <p>Suport Kipu's Rescue by buying our branded merchandise! 
                            <a href="/shop"><em><strong> Shop here</strong></em></a></p>
                        {/* </Col> */}
