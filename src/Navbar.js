  ...
  return ( 
    ...
    <div className='navbar'>
        <Navbar className="mx-auto" collapseOnSelect expand="md" variant="light" sticky="top">
          <Navbar.Brand href="/"><img class="logo align-middle" src='./Images/Logo.png' alt="brand logo"  /></Navbar.Brand>
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
              <Nav className="m-auto">
                ...
                <Nav.Link className="mx-4"href = "/rescue" > Adopt </Nav.Link> 
              ...
              <Button className="donateButton mx-4"  href="/donate"> Donate </Button>  
